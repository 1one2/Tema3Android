...
public class FirstFragment extends Fragment {
    ...
    private void setupViews()
    {
        ...
        author = view.findViewById(R.id.authorET);
    ...
    {
        RecyclerView recyclerView = view.findViewById(R.id.dataRV);
    ...
    private void insertBook()
    {
        ...
        if(titlu.isEmpty() || autor.isEmpty() || descriere.isEmpty())
        ...
        else
        {
            ...
            {
                if(book.title.equals(titlu) && book.author.equals(autor))
                {
                    toUpdate = true;
                    allBooks.remove(book);
                    break;
            ...
            if(toUpdate)
            {
                Book updatedBook = new Book(titlu, autor, descriere);
                ...
                Book toInsert = new Book(titlu, autor, descriere);
